    ...
    <>
      ...
      <div className="relative flex min-h-screen flex-col bg-zinc-50 font-sans text-zinc-800 dark:bg-gray dark:text-zinc-100 b">
        ...
        <section
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1633114339589-af68c03546cf?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170')",
          }}
        >
